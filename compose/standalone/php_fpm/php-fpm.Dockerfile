...
RUN install-php-extensions bcmath bz2 calendar dba enchant exif ffi ftp gd gettext gmp imap intl ldap mysqli oci8 odbc opcache pcntl  pdo_dblib pdo_firebird pdo_mysql pdo_oci pdo_odbc pdo_pgsql pgsql pspell shmop snmp soap sockets sysvmsg sysvsem sysvshm tidy xsl zip
